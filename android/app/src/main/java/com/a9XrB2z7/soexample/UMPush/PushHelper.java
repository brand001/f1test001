package com.a9XrB2z7.soexample.UMPush;
...
import com.a9XrB2z7.soexample.UMPush.PushConstants;
/**
 * PushSDK集成帮助类
 */
public class PushHelper {
    ...
    public static String DeviceTokens = "deviceTokens";
    /**
     * 预初始化
     */
    ...
    public static void init(final Context context) {
        ...
        pushAgent.setResourcePackageName("com.a9XrB2z7.soexample");
