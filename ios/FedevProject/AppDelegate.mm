...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  //TInstall初始化
  [TInstall initInstall:@"2O5KVT" setHost:@"https://feaffcodegetm2.com"];

  [FIRApp configure];

  /* Umeng init */
  [RNUMConfigure initWithAppkey:@"6391a6158de974689e9e2558" channel:@"App Store"];
...
-(void)userNotificationCenter:(UNUserNotificationCenter *)center didReceiveNotificationResponse:(UNNotificationResponse *)response withCompletionHandler:(void (^)())completionHandler{
  ...
  //将点击通知内容发到js
[[NSNotificationCenter defaultCenter] postNotificationName:@"NotificationClick"
                                                  object:nil
                                                userInfo:userInfo];
completionHandler();
}
