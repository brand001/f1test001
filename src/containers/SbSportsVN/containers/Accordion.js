            ...
            <View style={{ flex: 1 }}>
                <View>
                    <TouchableOpacity onPress={() => { this.shows(); }}>
                        <View style={[styles.titleView, { backgroundColor: isBlue ? "#EFEFF4" : "#2C2C2E" }]}>
                            <View style={styles.titles}>
                                <ImageForLeague LeagueId={this.props.tltleList.LeagueId} />
                                <Text style={{ color: isBlue ? "#222222" : "#BCBEC3", paddingLeft: 10, width: width * 0.82 }} numberOfLines={1}>{this.props.tltleList != "" && this.props.tltleList.LeagueName}</Text>
                            </View>
