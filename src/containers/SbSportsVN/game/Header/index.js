...
let banners = [
    { imgs: ImagesUrl.banner1Vn },
    { imgs: ImagesUrl.banner2Vn },
];
...
export default class Header extends Component {
    ...
    goDetaile(EventData) {
        ...
        PiwikEventDataHandle("SbSportsVN_MainpageBanner");
    ...
    _renderBannerItem1(item, index) {
        return (
            <View key={index} style={{ width: width + 25, height: 0.394 * (width + 20), borderRadius: 10, overflow: "hidden", alignSelf: "center" }}>
                <Image
                    source={item.imgs}
                    style={{ width: width + 25, height: 0.394 * (width + 25) }}
                />
            </View>
        );
    }
    ...
    render() {
        ...
        return (
            <View style={{ alignSelf: "center" }}>
                <View style={{ backgroundColor: "#00A6FF", height: width * 0.15, widdth: width }}></View>
                {
                    <View style={{ width: width, display: "flex", justifyContent: "center", alignItems: "center", paddingBottom: 10, marginTop: -65 }}>
                        <View
                            style={{ width: width + 25, height: 0.394 * (width + 25), display: "flex", justifyContent: "center", alignItems: "center" }}
                        >
                            {
                                // eventDatas.length > 0 &&
                                <View>
                        ...
                        <View style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row", marginTop: -15 }}>
                            {
