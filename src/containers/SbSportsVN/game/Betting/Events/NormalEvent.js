...
export class VerticalEvent extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, width: width, borderBottomColor: isBlue ? "#EFEFF4" : "transpatent", borderBottomWidth: 1, }}>
                <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", backgroundColor: isBlue ? "transparent" : "#3A3A3C" }}>
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, width: width, borderBottomColor: "#EFEFF4", borderBottomWidth: 1, }}>
                <View style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", backgroundColor: isBlue ? "transparent" : "#3A3A3C" }}>
                    ...
                    {hasFTCorrectScore
                        ...
                        <View style={{ paddingHorizontal: 4 }}>
                            ...
                            <Text style={{ marginLeft: 4, fontSize: 12, lineHeight: 22, color: "#666666" }}>Tỷ Số Chính Xác</Text>
                            {/* 全场波胆 */}
                                    ...
                                    return <View style={{ flex: 1, marginHorizontal: 4 }} key={index}>
                                        {selections.map((item, selectionIndex) => {
                                            return <OddsCell
                                                ...
                                                ClickOdds={ClickOdds}
                                                EventType="CORRECTSCORE"
                                                hasFTCorrectScore={hasFTCorrectScore}
                                            />;
                                        })}
                                    </View>;
                                })}
                            ...
                            {showViewMoreButtons ? <>
                                {!CorrectScoreViewMore ?
                                    ...
                                    >
                                        <Text style={{ color: "#00A6FF", fontSize: 12, lineHeight: 16, marginRight: 4 }}>Xem Thêm</Text><ArrowIcon width={16} height={16} fill={"#00A6FF"} direction='bottom' />
                                    </Touch> : null}
                                {CorrectScoreViewMore ?
                                    <Touch
                                        style={{ height: 49, display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }}
                                        onPress={this.toggleCorrectScoreViewMore}
                                    >
                                        <Text style={{ color: "#00A6FF", fontSize: 12, lineHeight: 16, marginRight: 4 }}>Thu Gọn</Text><ArrowIcon width={16} height={16} fill={"#00A6FF"} direction='top' />
                                    </Touch> : null}
                            </> : <View style={{ height: 25 }} />}
                        </View>
                        : <View style={{ width: width, height: 49, display: "flex", justifyContent: "center", alignItems: "center" }}>
                            <Text style={{ fontSize: 12, lineHeight: 22, color: "#999999" }}>Hiện trận đấu không có Tỷ Số Chính Xác</Text>
                            {/* 暂无波胆盘口 */}
                        </View>
                    }
                </View>
