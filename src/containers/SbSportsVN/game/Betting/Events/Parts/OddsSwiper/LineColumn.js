    ...
    render() {
        ...
        return (
            <View>
                {
                    LineData ? (
                        <View style={{ width: width * 0.25, paddingHorizontal: 2 }}>
                            <LineDescCell LineData={LineData} LeftOrRight={LeftOrRight} />
                            {/*主隊賠率*/}
                            <OddsCell
                                Vendor={Vendor}
                        ...
                        <View>
                            <View style={{ height: 40, justifyContent: "center" }}>
                                <Text style={{ width: width * 0.25, textAlign: "center", fontSize: 10, lineHeight: 15, color: isBlue ? "#666666" : "#CCCCCC" }}>
                                    {LeftOrRight === "LEFT" ? `Cược Chấp ${"\n"} Toàn Trận` : `Tài/Xỉu ${"\n"} Toàn Trận`}
                                    {/* {VendorPeriodName[PeriodId]}{LeftOrRight === 'LEFT' ? '让球' : '大小'} */}
                                </Text>
                            </View>
                            <View style={[styles.noactive, { backgroundColor: window.isBlue ? "#f7f7f7" : "#545457", }]}>
