...
class CornerCount extends React.Component {
    ...
    render() {
        ...
        return EventData && EventData.HasCornerData && EventData.SportId == 1 ? (
            <View style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row", paddingLeft: 8 }}>
                <Image resizeMode='stretch' source={ImagesUrl.jiao} style={{ width: 13, height: 13 }} />
