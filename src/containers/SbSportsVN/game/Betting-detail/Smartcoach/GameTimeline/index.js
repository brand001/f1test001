    ...
    render() {
        ...
        return (
            <View style={{ width: width, }}>
                <View>
                    <Text style={{ color: "#666666", fontSize: 12, lineHeight: 30, textAlign: "center" }}>dữ liệu</Text>
                    {/* 数据 */}
                    ...
                    />
                    <Text style={{ color: "#666666", fontSize: 12, lineHeight: 30, textAlign: "center" }}>cuộc thi đấu</Text>
                    {/* 赛况 */}
                    <GameInsights
                        type={type}
                        EventDetail={EventDetail}
