            ...
            <View style={{ flx: 1 }}>
                ...
                <View style={{ width: width, backgroundColor: "#fff" }}>
                    <View style={{ backgroundColor: "#EFEFF4" }}>
                        <Text style={{ lineHeight: 35, color: "#999", fontSize: 12, textAlign: "center" }}>thay thế</Text>
                        {/* 替补 */}
                    </View>
                                        ...
                                        <View style={styles.playersLeft} key={key}>
                                            {sub_in.minute && (
                                                <View style={styles.playerList}>
                                                    ...
                                                    <Image source={ImagesUrl.smartcoachSubIn} style={{ width: 12, height: 12 }} />
                                                </View>
                                            )}
                                            {sub_out.minute && (
                                                <View style={styles.playerList}>
                                                    <Text style={{ color: "#999", paddingRight: 12 }}>{sub_out.minute}`</Text>
                                                    <Image source={ImagesUrl.smartcoachSubOut} style={{ width: 12, height: 12 }} />
                                                </View>
                                            )}
                                            {
