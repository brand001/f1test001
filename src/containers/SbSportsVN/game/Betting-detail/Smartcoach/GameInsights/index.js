                                ...
                                return (
                                    ...
                                    <View key={key} style={styles.information}>
                                        ...
                                        <View style={styles.informationIcon}>
                                            {/* 黄牌 */}
                                            {status_type == 4 && (
                                                <Image resizeMode='stretch' source={ImagesUrl.smartcoachYellow} style={{ width: 12, height: 18 }} />
                                            )}
                                            {/* 红牌 */}
                                            {status_type == 5 && (
                                                <Image resizeMode='stretch' source={ImagesUrl.smartcoachRed} style={{ width: 12, height: 18 }} />
                                            )}
                                            {/* 替补 */}
                                            {status_type == 8 && (
                                                <Image resizeMode='stretch' source={ImagesUrl.smartcoachOutIn} style={{ width: 17, height: 17 }} />
                                            )}
                                            {/* 角球 */}
                                            {status_type == 3 && (
                                                <Image resizeMode='stretch' source={ImagesUrl.redJB} style={{ width: 17, height: 17 }} />
                                            )}
                                        </View>
                            ...
                            type == 0 && (
                                <View style={{ alignItems: "center" }}>
                                    <Touch onPress={() => { this.setState({ showMore: 9999999 }); }} style={[styles.showMore, { width: width * 0.85 }]}>
                                        <Text style={{ color: "#00A6FF", textAlign: "center", lineHeight: 23 }}>tải thêm</Text>
                                        {/* 显示更多 */}
                                    </Touch>
                                </View>
                            )}
                                ...
                                type == 1 && (
                                    <View style={{ alignItems: "center" }}>
                                        <Touch onPress={() => { this.setState({ showMore: 9999999 }); }} style={styles.showMore}>
                                            <Text style={{ color: "#00A6FF", fontSize: 12, }}>tải thêm</Text>
                                            {/* 显示更多 */}
                                        </Touch>
                                    </View>
                                )}
