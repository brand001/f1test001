...
const tabList = [
    { name: "即时情报", icon: ImagesUrl.smartcoachTab1, icons: ImagesUrl.smartcoachActive1, active: false },
    { name: "赛程", icon: ImagesUrl.smartcoachTab2, icons: ImagesUrl.smartcoachActive2, active: false },
    { name: "阵容", icon: ImagesUrl.smartcoachTab3, icons: ImagesUrl.smartcoachActive3, active: false },
    { name: "赛前情报", icon: ImagesUrl.smartcoachTab4, icons: ImagesUrl.smartcoachActive4, active: false },
];
...
class Smartcoach extends Component {
     ...
     */
    getSmartcoachToken = () => {
        //let hideLoading = Toasts.loading();
    ...
    */
    PregameInsights = (Token, matchid) => {
        ...
        fetch(HostConfig.Config.SmartCoachApi + `/insights/pregame/${matchid}/home?locale=vi`, tokenFetchParams)
            .then((response) => response.json())
            .then((Data) => {
        ...
        fetch(HostConfig.Config.SmartCoachApi + `/insights/pregame/${matchid}/away?locale=vi`, tokenFetchParams)
            .then((response) => response.json())
            .then((Data) => {
                if (!(Data instanceof Array)) {
                    return;
    ...
    */
    ...
    piwikBtn(key) {
        key == 0 && PiwikEventDataHandle("SbSportsVN_LiveInsightsMatchPage");
        key == 1 && PiwikEventDataHandle("SbSportsVN_GameTimelineMatchPage");
        key == 2 && PiwikEventDataHandle("SbSportsVN_LineUpMatchPage");
        key == 3 && PiwikEventDataHandle("SbSportsVN_PregameInsightsMatchPage");
    }
