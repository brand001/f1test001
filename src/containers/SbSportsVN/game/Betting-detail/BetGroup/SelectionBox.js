...
class SelectionBox extends React.Component {
    render() {
        ...
        // BTI 三項需處理排序
        const shouldSortThreeWay = Vendor.configs?.VendorName === "BTI" && Vendor.ifThreeWayLine && Vendor.ifThreeWayLine(LineData);
        const SelectionsData = shouldSortThreeWay ? Vendor.sortThreeWay(Selections) : Selections;
        //波膽特別處理
                        ...
                        <View style={{ display: "flex", justifyContent: "space-around", alignItems: "center", width: width, flexDirection: "row", flexWrap: "wrap", }}>
                            <View>
                                <Text style={{
                                    ...
                                    textAlign: "center", fontSize: 12, color: isBlue ? "#000" : "#F5F5F5"
