...
class DetailHeader extends React.Component {
    ...
    componentDidMount() {
        //this.setState({ src: "https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8" }); //不使用默認的影片
    ...
    render() {
        ...
        let width = isLandscapeShow && isLandscape ? headerWidth * 0.5 : headerWidth;
                ...
                >
                    {
                        !this.props.thumbStatus && (
                            <View style={[styles.Betting_header, { width: width }]}>
                                <Touch
                                    onPress={() => {
                                        PiwikEventDataHandle("SbSportsVN_MinimizeMatchFeature");
                    ...
                    <View style={[styles.Betting_header, { width: this.props.headerWidth }]}>
                        {
                            ...
                            // 			}}
                            // 		>
                            // 			<ArrowIcon direction={'bottom'} fill="#fff" width={22} height={22}></ArrowIcon>
                            // 		</Touch>
                            // 		{/* 關閉按鈕 */}
                    ...
                    {this.state.showType === 0 ? <View style={{ height: height, display: "flex", justifyContent: "center", alignItems: "center", width: width }}>
                            ...
                            <View >
                                {
                                    EventData.IsRB ? <View style={styles.itemCenter}>
                                        ...
                                        : <View style={styles.noGame_info}>
                                            ...
                                            <Text style={{ color: "#fff" }}>Sắp diễn ra</Text>
                                            {/* 未开始 */}
                                        </View>
                                }
                            </View>
                        ...
                        <View style={styles.Footer_menu}>
                                ...
                                EventData.HasLiveStreaming ?
                                    <Touch
                                        ...
                                        onPress={() => {
                                            ...
                                            PiwikEventDataHandle("SbSportsVN_LivestreamMatchFeature");
                                            // this.player.play();
                                ...
                                EventData.HasVisualization ?
                                    <Touch
                                        ...
                                        onPress={() => {
                                            ...
                                            PiwikEventDataHandle("SbSportsVN_AnimationMatchFeature");
                                            this.props.setDefaultShowType(2);
                                            this.setState({ showType: 2 });
                                        }}>
                                        <Text style={{ color: "#fff", fontSize: 12, fontWeight: "600" }}>Theo Dõi Bóng</Text>
                                        {/* 动画 */}
                                    </Touch>
                                    : null
                            }
                                ...
                                EventData.HasStatistic ?
                                    <Touch
                                        ...
                                        onPress={() => {
                                            ...
                                            PiwikEventDataHandle("SbSportsVN_StatsMatchFeature");
                                            Toasts.info("Chưa mở!！");
                                        }}>
                                        <Text style={{ color: "#fff", fontSize: 12, fontWeight: "600" }}>Dữ Liệu</Text>
                                        {/* 数据 */}
                                    </Touch>
                                    : null
                            }
                            {
                                ...
                                <Text style={{ color: "#bcbec3", fontSize: 12, fontWeight: "600" }}>Không có Video | Theo Dõi Bóng | Dữ Liệu</Text>
                            }
                            {/* 暂无视频/动画/数据 */}
                        </View>
                    </View> : null}
                                    ...
                                    }
                                    {
                                        ...
                                        <Touch
                                            onPress={() => {
                                                ...
                                                PiwikEventDataHandle("SbSportsVN_ViewOddsLandscapeMatchFeature");
                                            }}
                                            style={{ paddingRight: DeviceInfoIos ? 40 : 10, paddingBottom: 10 }}
                                        >
                                            <Image resizeMode='stretch' source={ImagesUrl.detailBetRecord} style={{ width: 35, height: 35 }} />
                                        </Touch>
                                    }
                                </View>
                            )
