            ...
            <View>
                ...
                >
                    <View style={isLandscape ? styles.depModalMin : styles.depModal}>
                        ...
                        {
                            isLandscape &&
							<Touch onPress={() => { this.setState({ isBottomSheetVisible: false }); }} style={[styles.LandscapeClose, { width: width, height: detailHeight, right: DeviceInfoIos ? 8 : 0 }]}></Touch>
                        }
                        <ScrollView
                            showsHorizontalScrollIndicator={false}
                            showsVerticalScrollIndicator={false}
                            style={isLandscape ? [styles.modalCenterLandscape, { width: width, height: detailHeight * 0.5, right: DeviceInfoIos ? 8 : 0 }] : styles.modalCenter}
                        >
                            <View>
                            ...
                            <View style={{ display: "flex", justifyContent: "flex-start", alignItems: "center", flexDirection: "row", flexWrap: "wrap" }}>
                                {hasDefaultButton ? ( //默認按鈕(詳情頁使用)
                                    ...
                                    >
                                        <Text style={{ color: selectedItem === null ? "#fff" : "#999999" }}>{defaultButtonText != "" && defaultButtonText}</Text>
                                    </Touch>
                                ) : null}
