            ...
            <View>
                ...
                >
                    <View style={styles.depModal}>
                        <Touch onPress={() => { this.setState({ isBottomSheetVisible: false }); }} style={{ width: width, height: height * 0.65 }}></Touch>
                        <View style={styles.modalCenter}>
                            <View>
                                <Text style={{ lineHeight: 40, textAlign: "center", fontSize: 16, fontWeight: "500", paddingBottom: 15 }}>Chọn Thời Gian</Text>
                                {/* 选择日期 */}
                            </View>
