                    ...
                    <View style={{ height: (height * 0.9) - 90 }}>
                        ...
                        >
                            <View style={{ paddingBottom: 120 }}>
                                ...
                                />
                                <View style={[styles.SystemParlayBet, { width: width - 20, marginTop: 10, backgroundColor: isBlue ? "#efeff4" : "#3A3A3C" }]}>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <View
                                                        ...
                                                        // 	: ''}`}
                                                    />
                                                    <Text style={{ paddingLeft: 12, color: isBlue ? "#000" : "#F5F5F5" }}>
                                    ...
                                    <Touch style={[styles.capInput, { width: width - 50, borderColor: this.state.ShowKeyboard ? "#00A6FF" : isBlue ? "#fff" : "#00A6FF", backgroundColor: isBlue ? "#fff" : "#222222" }]} onPress={() => { this.setState({ ShowKeyboard: true }); }}>
								    <Text style={{ color: isBlue ? "#000" : "#CCCCCC", lineHeight: 35, fontWeight: "bold" }}>{AmountFixed}</Text>
                                        <Text style={{ color: isBlue ? "#000" : "#CCCCCC", fontWeight: "bold", lineHeight: 35, paddingLeft: 4, }}>VNĐ</Text>
                                    </Touch>
						...
						/> */}
									...
									<View style={[styles.maxMinErr2, { width: width - 50, }]}>
									    <View style={[styles.maxMinErrView2, { width: width - 50, }]}>
									        {/* 金额必须为￥或以上的金额  */}
									        {Amount != "" &&
											Amount < MinAmount && <Text style={styles.maxMinErrTxt}>Số tiền tối thiểu phải là {numberWithCommas(MinAmount)} VNĐ</Text>}
									        {Amount != "" &&
											Amount > MaxAmount && <Text style={styles.maxMinErrTxt}>Số tiền tối đa phải là {numberWithCommas(MaxAmount)} VNĐ</Text>}
									        {/* 金额必须为￥  */}
									    </View>
									</View>
                                    }
                                    ...
                                    <View className="ShowKeyboardBox ">
                                        <Text style={{ fontSize: 12, marginTop: 10, textAlign: "right", color: "#BCBEC3" }}>
                                            {/* 最低-最高： */}
									Tối Thiểu - Tối Đa: {numberWithCommas(MinAmount)} VNĐ - {numberWithCommas(MaxAmount)} VNĐ
                                        </Text>
                                    </View>
