                ...
                return item ? (
                    <View key={index}>
                        <View style={[styles.Betinputlist, { width: width }]}>
                            <View style={[styles.input_area, { width: width - 20, backgroundColor: isBlue ? "#BCBEC3" : "#666666" }]}>
                                {
                                ...
                                <View style={[styles.itemRight, { width: width - 35 - 20, backgroundColor: isBlue ? "#EFEFF4" : "#3A3A3C" }]}>
                                    ...
                                    <View style={[styles.iteamTime, { width: width - 55, }]}>
                                        ...
                                        <Text style={{ color: isBlue ? "#000" : "#F5F5F5", textAlign: "right", width: (width - 80) * 0.4 }}>{item.SelectionDesc}</Text>
                                    </View>
                                    <View style={[styles.iteamInput, { width: width - 55, }]}>
                                        ...
                                        {BetActiveType === 1 && (
                                            ...
                                            >
                                                <Text style={{ color: isBlue ? "#000" : "#F5F5F5", lineHeight: 35, fontWeight: "bold" }}>{AmountFixed}</Text>
                                                <Text style={{ color: isBlue ? "#000" : "#F5F5F5", fontWeight: "bold", lineHeight: 35, paddingLeft: 4, }}>VNĐ</Text>
                                        ...
                                        BetSettings != null && (
                                            <View style={[styles.lightGray, { width: width - 55 }]}>
                                                ...
                                                <Text style={{ fontSize: 12, color: "#BCBEC3" }}>
                                                    {/* 最低-最高: */}
                                                    Tối Thiểu - Tối Đa: {targetBetSetting ? (
                                                        numberWithCommas(targetBetSetting.MinAmount)
                                                    ) : (
                                                        0
                                                    )} VNĐ - {targetBetSetting ? (
                    ...
                    <View className="errortxt" key={index}><Text>Cược Đã Đóng</Text></View>//此盘口关闭，或刷新试试！
                );
            })}
        </>;
    }
