...
let banners = [
    { imgs: ImagesUrl.banner1Cn },
    { imgs: ImagesUrl.banner2Cn },
];
...
class Header extends Component {
    ...
    goDetaile(EventData) {
        ...
        PiwikEventDataHandle("SbSportsCN_MainpageBanner");
    ...
    render() {
        ...
        return (
            <View>
                {
                    <View style={{ width: width, paddingHorizontal: 10, display: "flex", justifyContent: "center", alignItems: "center", paddingBottom: 10, paddingTop: 8 }}>
                        <View
