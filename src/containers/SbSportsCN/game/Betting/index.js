...
import { LogoIcon, CalendarIcon } from "$Components/icons/index";
...
class Betting extends React.PureComponent {
    ...
    clickOdds = (selectionData) => {
        ...
        PiwikEventDataHandle("SbSportsCN_OddsMainpageVertical");
            ...
            <View style={{ flex: 1, backgroundColor: "rgba(242,242,242,1)" }}>
                {Loading ? (
                    ...
                    BetType.MarketId == 4 ?
                        ...
                        :
                        <View style={{ display: "flex", justifyContent: "center", alignItems: "center", paddingTop: 35 }}>
                            <LogoIcon fill={Color.theme} scale={.9}></LogoIcon>
