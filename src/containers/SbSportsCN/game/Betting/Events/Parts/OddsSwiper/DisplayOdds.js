    ...
    render() {
        ...
        return SelectionData ? (
            <View style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
                ...
                <View>
                    {UpOrDown === "UP" ? <Image resizeMode='stretch' source={ImagesUrl.roundUpCn} style={{ width: 6, height: 6 }} /> : null}
                    {UpOrDown === "DOWN" ? <Image resizeMode='stretch' source={ImagesUrl.roundDownCn} style={{ width: 6, height: 6 }} /> : null}
                </View>
            </View>
        ) : (
            <View >
