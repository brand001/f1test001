                        ...
                        <View style={{ paddingHorizontal: 4 }}>
                            ...
                            {showViewMoreButtons ? <>
                                {!CorrectScoreViewMore ?
                                    ...
                                    >
                                        <Text style={{ color: "#00A6FF", fontSize: 12, lineHeight: 16, marginRight: 4 }}>查看更多</Text><ArrowIcon width={16} height={16} fill={"#00A6FF"} direction='bottom' />
                                    </Touch> : null}
                                {CorrectScoreViewMore ?
                                    <Touch
                                        style={{ height: 49, display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }}
                                        onPress={this.toggleCorrectScoreViewMore}
                                    >
                                        <Text style={{ color: "#00A6FF", fontSize: 12, lineHeight: 16, marginRight: 4 }}>查看更少</Text><ArrowIcon width={16} height={16} fill={"#00A6FF"} direction='top' />
                                    </Touch> : null}
