                    ...
                    <View>
                        <View style={styles.HomeTeam}>
                            <View style={styles.Names}>
                                <ImageForTeam TeamId={HomeTeamId} Vendor={Vendor} IconUrl={HomeIconUrl} />
                        ...
                        <View style={styles.HomeTeam}>
                            <View style={styles.Names}>
                                <ImageForTeam TeamId={AwayTeamId} Vendor={Vendor} IconUrl={AwayIconUrl} />
        ...
        return (
            <View className="ball">
                <View style={[styles.nameNumber, { backgroundColor: goalkeeper }]}>
                    {/* 进球 */}
                    {goals.minutes && <View style={styles.goals}><Image resizeMode='stretch' source={ImagesUrl.smartcoachGoals} style={{ width: 14, height: 14 }} /></View>}

                    <Text numberOfLines={1} style={{ fontSize: 12, color: team == "Home" ? "#fff" : "#000" }}>{d.shirt_number}</Text>

                    {/* 黄牌 */}
                    {yellow.minute && <View style={styles.yellow}><Image source={ImagesUrl.smartcoachYellow} style={{ width: 9, height: 12 }} /></View>}
                    {/* 红牌 */}
                    {red.minute && <View style={styles.red}><Image source={ImagesUrl.smartcoachRed} style={{ width: 9, height: 12 }} /></View>}
                    {/* 上场 */}
                    {sub_in.minute && <View style={styles.sub_in}><Image source={ImagesUrl.smartcoachSubIn} style={{ width: 12, height: 12 }} /></View>}
                    {/* 下场 */}
                    {sub_out.minute && <View style={styles.sub_out}><Image source={ImagesUrl.smartcoachSubOut} style={{ width: 12, height: 12 }} /></View>}
                </View>
            </View>
        );
    }
