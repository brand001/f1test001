...
import { ShareIcon, ArrowIcon } from "$Components/icons/index";
/*
...
class BettingDetail extends React.Component {
    ...
    ShowBottomSheet = (type) => {
        if (this.props.EuroCupBet) {
            PiwikEventDataHandle("SbSportsCN_OpenBetCartEUROPage");
        } else {
            PiwikEventDataHandle("SbSportsCN_MatchPageBetcart");
        }
    ...
    clickOdds = (selectionData) => {
        ...
        PiwikEventDataHandle("SbSportsCN_OddsMatchpage");
    ...
    clickLineGroup = (LineGroupId = null) => {
        ...
        if (LineGroupId !== null) {
            PiwikEventDataHandle("SbSportsCN_MatchpageOdds");
        }
    };
    ...
    getSiteUrl = () => {
        return timeout_fetch(
            fetch("https://feappinstallurla.com/CMSFiles/F1APP/FUNSBRedirect.json?v=" + Math.random(), { method: "GET" })
    ...
    render() {
        ...
        return (
            <WrapView style={{ flex: 1, backgroundColor: "#00a6ff" }}>
                {/* {!window.GetSelfExclusionRestriction && <HomeHeader sbType={'IPSB'} />} */}
                <View
                    ...
                    >
                                                    ...
                                                    <Touch onPress={() => {
                                                        ...
                                                        this.setState(
                                                            ...
                                                            () => {
                                                                ...
                                                                PiwikEventDataHandle("SbSportsCN_MatchPageViewMore");
                                                            }
                                                        );
                        ...
                        {EventDetail != "" && EventDetail != null ? EventDetail.IsOutRightEvent ? (
                                                ...
                                                return (
                                                    <View style={styles.OddsList} key={k}>
                                                        <View style={styles.oddTeam}>
                                                            ...
                                                            <Image resizeMode='stretch' source={ImagesUrl.fun88Cn} style={{ width: 25, height: 25 }} />
                            ...
                            <View style={{ display: "flex", justifyContent: "center", alignItems: "center", paddingTop: 50 }}>
                                ...
                                <Image resizeMode='stretch' source={ImagesUrl.nodataCn} style={{ width: 90, height: 59 }} />
