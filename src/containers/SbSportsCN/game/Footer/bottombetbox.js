...
import { SuccessIcon, FailIcon } from "$Components/icons/index.js";
            ...
            <View>
                {
                    ...
                    >
                        <View style={isLandscape ? [styles.boxViewisLandscape, { width: width, height: Platform.OS == "android" ? height : height, right: 0 }] : styles.boxView}>
