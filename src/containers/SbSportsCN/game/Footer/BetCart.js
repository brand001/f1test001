...
import { ACTION_SbBetCartTransferPopup } from "$LIB/redux/actions/UserSettingAction";
...
class BetCart extends React.Component {
    ...
    placeBet = async (
        ...
        const updateBetResultStatus = (thisKey, newStatus, errorMsg = null) => {
            this.setState((state, props) => {
                ...
                console.log("this.state.BettingList ", this.state.BettingList);
            ...
            this.props.Vendor
                ...
                .catch((error) => {
                    ...
                    if (typeof error === "object" && error.isVendorError === true) {
                        ...
                        console.log("VendorErrorType ", VendorErrorType);
                        msg = error.ErrorMsg;
                        ...
                        if (
                            ...
                            this.props.Vendor.getBetInfo(BetActiveType != 1 ? 2 : 1, betInfo.Selections)
                                ...
                                .catch(e => {
                                    ...
                                    //發生錯誤就當作投注失敗
                                    updateBetResultStatus(key, 6, "网络异常"); //3投注失敗
                                    PIWIKBetResult(false);
    ...
    ClickTabmenu = (type) => {
        if (type == 1) {
            PiwikEventDataHandle("SbSportsCN_BetCartSinglebet");
        } else if (type == 1) {
            PiwikEventDataHandle("SbSportsCN_BetCartCombobet");
        } else {
            PiwikEventDataHandle("SbSportsCN_BetCartSystemCombo");
        }
                        ...
                        <View style={[styles.headerTop, { width: width, }]}>
                            ...
                            <View style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row" }} >
                                {this.props.userInfo.isGettingBalance ? (
                                    ...
                                    <TouchableOpacity
                                        onPress={() => {
                                            this.props.sbBetCartTransferPopup();
                                        }}
                                        style={{ backgroundColor: "#00000029", borderRadius: 5, padding: 6, marginRight: 8 }}
                                    >
                                        <Text style={{ color: "#fff" }}>¥{numberWithCommas(this.props.userInfo.balanceSB)}</Text>
                                    </TouchableOpacity>
                                )}
                                {this.props.userInfo.isGettingBalance ? (
                                    <View />
                        ...
                        <ScrollView>
                            ...
                            <View style={StartBettingloading == 1 ? styles.BottomBtnLoding : styles.BottomBtn}>
                                {(StartBettingloading != 3 && StartBettingloading != 6) && (<>
                                    <Touch
                                        ...
                                        onPress={() => {
                                            ...
                                            this.props.betCart_setIsComboBet(false, Vendor.configs.VendorName);
                                            this.props.CloseBottomSheet();
                                            PiwikEventDataHandle("SbSportsCN_ContinueBetCart");
                                        }}
                                    >
                                    ...
                                    <Touch
                                        ...
                                        onPress={() => {
                                            ...
                                            if (this.props.EuroCupBet || this.props.EuroCupBetDetail) {
                                                ...
                                                PiwikEventDataHandle("SbSportsCN_BackMainpage");
                                ...
                                {StartBettingloading == 6 && (
                                    ...
                                    >
                                        <Text style={styles.cantEnterTxt}>查看投注单</Text>
                                        {/* 去投注記錄 */}
                                    </Touch>
                                )}
                                {StartBettingloading == 3 && (
...
const mapDispatchToProps = {
    ...
    sbBetCartTransferPopup: ACTION_SbBetCartTransferPopup,
};
