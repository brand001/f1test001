                ...
                <View style={[styles.BetingBtn, { width: width, }]}>
                        ...
                        <Touch
                            ...
                            onPress={() => {
                                ...
                                if (this.props.EuroCupBet || this.props.EuroCupBetDetail) {
                                    PiwikEventDataHandle("SbSportsCN_ClearBetCartEUROPage");
                                } else {
                                    PiwikEventDataHandle("SbSportsCN_ClearBetcart");
                                }
                            }}
                        >
                    ...
                    <Touch
                        ...
                        onPress={() => {
                            ...
                            if (this.props.EuroCupBet || this.props.EuroCupBetDetail) {
                                PiwikEventDataHandle("SbSportsCN_PlacebetEUROPage");
                            } else {
                                PiwikEventDataHandle("SbSportsCN_Placebet");
                            }
                        }}
                    >
