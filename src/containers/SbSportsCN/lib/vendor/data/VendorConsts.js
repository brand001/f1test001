...
export const VendorErrorType = {
    ...
    BET_Place_PARLAY_ODDS_MIN: 13150, //赔率小于串关最小限制赔率
    BET_Place_PARLAY_PAYOUT_MAX: 13160, //此串关组合达到赔付上限
...
export const SelectionStatusType = {
    ...
    PARLAYODDSMIN: 13150, //赔率小于串关最小限制赔率 (SABA獨有)
    PARLAYPAYOUTMAX: 13160, //此串关组合达到赔付上限 (SABA獨有)
    OK: 100, //成功
    ERROR: 350, //獲取投注信息錯誤
