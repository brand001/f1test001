                            ...
                            <View style={styles.setPushView}>
                                ...
                                <Touch onPress={() => { this.checkPush("goalMyFavorite"); }} style={styles.setPushList}>
                                    ...
                                    <SuccessIcon
                                        ...
                                        type={goalMyFavorite ? "fill" : "ring"}
                                        fill={goalMyFavorite ? "#00A6FF" : "#CCC"} />
                                </Touch>
                                <Touch onPress={() => { this.checkPush("goalIBet"); }} style={styles.setPushList}>
                                    ...
                                    <SuccessIcon
                                        ...
                                        height={22}
                                        wrapStyle={{ marginRight: 15 }}
                                        type={goalIBet ? "fill" : "ring"}
                                        fill={goalIBet ? "#00A6FF" : "#CCC"} />
                                </Touch>
                                <Touch onPress={() => { this.checkPush("goalAllRB"); }} style={styles.setPushList}>
                                    ...
                                    <SuccessIcon
                                        ...
                                        height={22}
                                        wrapStyle={{ marginRight: 15 }}
                                        type={goalAllRB ? "fill" : "ring"}
                                        fill={goalAllRB ? "#00A6FF" : "#CCC"} />
                                </Touch>
