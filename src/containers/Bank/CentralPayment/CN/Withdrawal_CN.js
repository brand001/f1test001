...
import { WithdrawalPage } from "central-payment-m1";
...
class Withdrawal_CN extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            configSet: false,
    ...
    async componentDidMount() {
        const privateParams = {
            ...
            goRecord: () => {
                Actions.pop();
                Actions.Recordes({ reportType: "withdraw" });
            },
...
export default connect(mapStateToProps, mapDispatchToProps)(Withdrawal_CN);
