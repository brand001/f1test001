...
import { TransHistoryPage } from "central-payment-m1";
...
class Records_CN extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            configSet: false,
    ...
    render() {
        ...
        return <TransHistoryPage reportType={reportType} transactionId={transactionId} />;
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(Records_CN);
